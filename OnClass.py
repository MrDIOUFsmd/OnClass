...
from config import ontology_data_dir, scrna_data_dir, model_dir

print('°----------------------------°')
print('| Packages are well imported | ')
print('°----------------------------°')
print()

train_file = scrna_data_dir + 'Tabula_Muris_Senis/tabula-muris-senis-droplet-official-raw-obj.h5ad'
test_file = scrna_data_dir +'Tabula_Muris_Senis/tabula-muris-senis-facs-official-raw-obj.h5ad'
"""
